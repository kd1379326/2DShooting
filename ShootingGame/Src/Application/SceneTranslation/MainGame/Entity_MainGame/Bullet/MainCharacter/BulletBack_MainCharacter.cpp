#include "BulletBack_MainCharacter.h"
...
C_BulletBack_MainCharacter::C_BulletBack_MainCharacter()
{
...
// 初期化内容はここに
void C_BulletBack_MainCharacter::Init(Math::Vector2 A_Position, bool AF_Turning)
{
	// 画像のパス(在処)を伝える
	...
	// 移動速度
	if (!AF_Turning) { M_Entity.MS_MoveSpeed = { 20, 20 }; }
...
// 操作関連の更新内容はここに
void C_BulletBack_MainCharacter::Action()
{
	// 上に飛ばす処理
...
void C_BulletBack_MainCharacter::Update()
{
	// 体力が0になったらやられた判定にする。
...
// 描画処理はここに
void C_BulletBack_MainCharacter::Draw()
{
	// 描画情報を伝える
...
// デバッグ画面に表示させたいものはここに
void C_BulletBack_MainCharacter::ImGuiUpdate()
{

}

// このクラスの実体が削除された時に行う領域解放処理。
void C_BulletBack_MainCharacter::Release()
{
	// 画像を入れている領域を解放する。
